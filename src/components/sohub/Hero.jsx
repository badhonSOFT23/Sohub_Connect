...
export default function Hero() {
  return (
    <section className="w-full bg-white dark:bg-[#121212] py-16 md:py-20 lg:py-28">
      <div className="max-w-[1240px] mx-auto px-6 md:px-8 lg:px-12">
        ...
        <div className="text-center space-y-8 max-w-5xl mx-auto">
          ...
          <h1 className="font-plus-jakarta-sans font-bold text-[#111111] dark:text-white leading-[1.1] text-4xl md:text-5xl lg:text-6xl">
            PBX, <span className="text-[#22C55E]">Without Buildings.</span>
            <br />
            <span className="text-[#22C55E]">Without Phone Numbers.</span>
          </h1>
          ...
          <p className="font-inter text-[#525252] dark:text-white dark:text-opacity-70 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
            The first borderless, cloud-native PBX built for Bangladesh's SOHO
            and e-commerce businesses. One click. Instant conversation. No
            numbers. No waiting.
          </p>
        ...
        <div className="mt-16 relative max-w-5xl mx-auto">
          <div className="relative bg-white dark:bg-[#1E1E1E] rounded-2xl border border-[#E5E7EB] dark:border-gray-700 shadow-2xl overflow-hidden">
            {/* Browser Chrome */}
            <div className="flex items-center px-4 py-3 bg-[#F9FAFB] dark:bg-[#262626] border-b border-[#E5E7EB] dark:border-gray-700">
              ...
              <div className="flex-1 flex justify-center">
                <div className="bg-white dark:bg-[#1E1E1E] rounded-md px-3 py-1 text-xs text-[#737373] dark:text-white dark:text-opacity-60 border border-[#E5E7EB] dark:border-gray-600">
            ...
            {/* Dashboard Preview */}
            <div className="aspect-[16/9] bg-gradient-to-br from-[#F0FDF4] to-[#DCFCE7] dark:from-[#0A0A0A] dark:to-[#1A1A1A] p-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h3 className="font-inter font-bold text-2xl text-[#111111] dark:text-white mb-1">
                ...
                <div className="flex items-center space-x-3">
                  <div className="flex items-center space-x-2 bg-white dark:bg-[#1E1E1E] rounded-full px-4 py-2 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Click-to-Call Card */}
                <div className="bg-white dark:bg-[#1E1E1E] rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-[#22C55E] dark:hover:border-[#22C55E] transition-all duration-200 cursor-pointer">
                  <div className="w-10 h-10 bg-[#DCFCE7] dark:bg-[#22C55E]/20 rounded-lg flex items-center justify-center mb-4">
                    <Phone size={20} className="text-[#22C55E]" />
                  </div>
                  <h4 className="font-inter font-semibold text-base text-[#111111] dark:text-white mb-2">
                    Click-to-Call
                  </h4>
                  <p className="font-inter text-sm text-[#6B7280] dark:text-white dark:text-opacity-70">
                    3 buttons active
